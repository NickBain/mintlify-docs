...
Wey Roadmap supports multi-level parent-child relationships between items. This allows you to model complex product structures where work is broken down from strategic initiatives to detailed tasks.
