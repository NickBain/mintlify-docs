...
The List View displays Gnatt list of all your roadmap items in a structured, expandable list format. It's ideal for reviewing details, managing large numbers of items, and understanding hierarchical relationships.

<Frame>
  <img src="/images/list" alt="List View" />
</Frame>
