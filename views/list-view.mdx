...
The List View displays all your roadmap items in a structured, expandable list format. It's ideal for reviewing details, managing large numbers of items, and understanding hierarchical relationships.

<Frame>
  <img src="/images/placeholder-list-view.png" alt="List View" />
